...
#VALUES ("1","restaurant","Ahmet", "Akinsql", "ahmet@gmail.com",  SHA2(CONCAT("123456","KABLO_SOYMA_MAKINESI"), 224), "Lefkoşa", 05338668666);
#INSERT INTO users (user_id, first_name, last_name, email, password, city, phone_number)
#VALUES ("2","bar","Buse", "Hermione", "buse@buse.com",  SHA2(CONCAT("654123","KABLO_SOYMA_MAKINESI"), 224), "Mağusa", 05338444444);
#INSERT INTO users (user_id, first_name, last_name, email, password, city, phone_number)
#VALUES ("3","cinema","Ahmet", "Mısır-x", "ahmet@ahmet.com",  SHA2(CONCAT("654321","KABLO_SOYMA_MAKINESI"), 224), "Omorfo", 05338555555);
...
#INSERT INTO venues (venue_id, name, description, city, phone_number,work_hours,facebook, instagram, twitter, image)
#VALUES (1, "shamrock", "bar and live music", "Mağusa", 0533845552244,"21:00-02:00", "www.facebook.com/shamrock", "www.instagram.com/shamrock", "www.twitter.com/shamrock","shamrock.jpg" );

#INSERT INTO venues (venue_id, name, description, city, phone_number,work_hours,facebook, instagram, twitter, image)
#VALUES (1, "cage club", "electronic music", "Girne", 0533845552255,"22:00-02:00", "www.facebook.com/cage", "www.instagram.com/cage", "www.twitter.com/cage","cage.jpg" );
